...
Common labels
*/}}
{{- define "amavis.labels" -}}
helm.sh/chart: {{ include "amavis.chart" . }}
{{ include "amavis.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "amavis.selectorLabels" -}}
app.kubernetes.io/name: {{ include "amavis.name" . }}
...
*/}}
{{- define "amavis.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "amavis.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
...
*/}}
{{- define "amavis.serviceName" -}}
{{- if include "amavis.isIpAddress" .Value }}
	{{- print .Value }}
{{- else -}}
...
{{/*
Renders the full mail relay hostname if required
*/}}
{{- define "amavis.relayHostname" -}}
{{- include "amavis.serviceName" (dict "Context" . "Value" .Values.relayHostname) }}
{{- end -}}
